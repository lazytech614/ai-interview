...
export const SectionHeading = ({ gray, gold }: any) => (
  <h2
...
export default function PageHeader({ label, gray, gold, description, right }: any) {
  return (
